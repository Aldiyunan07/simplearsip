    ...
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <h4 class="modal-title">
            <center>
              <font><b>
                  <font color="purple">
                    << /font>
                      <font color="#1abc9c">P</font>K<font color="#1abc9c">L</font>K <font color="purple">/></font>
                </b></font>
            </center>
          </h4>
        </div>
        <div class="modal-body">
          ...
          ?><center>
                <font class="alert alert-danger modal-title">Login gagal, periksa kembali informasi login anda.</font>
              </center>
          <?php
            }
          }
