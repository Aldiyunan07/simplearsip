                  ...
                  while ($r = mysqli_fetch_array($tampilkan)) {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?php echo $r['3']; ?></td>
                        <td><?php echo $r['9']; ?></td>
                        <td><a href="detail.php?detail=<?php echo $r['1']; ?>" class="btn btn-default">
                            <font class="fa fa-eye">Detail</font>
                          </a></td>
                        <td>
                          <a href="?hapus=<?php echo $r['1']; ?>" class="btn btn-danger" onclick="return confirm('Yakin data akan dihapus ?');">
